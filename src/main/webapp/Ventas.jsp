...
<ul>
    ...
    <li id="seleccionado"><a href="Ventas.jsp">Ventas</a></li>
    <li><a href="SolicitudesCompra.jsp">Solicitudes de compra</a></li>
    <li><a href="SolicitudesVenta.jsp">Solicitudes de venta</a></li>
</ul>
<%
    if (gestionAPP.getUsuario() != null) {
        ArrayList<Trato> ventas = gestionAPP.getHistoricoVentas();
        if (ventas == null || ventas.isEmpty()) out.print("<p>No has realizado ninguna venta</p>");
        else {
            out.print("<div id=\"central\">");
            for (Trato t : ventas) {
                out.print("<div class=\"venta\">");
