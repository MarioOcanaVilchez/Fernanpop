...
<div class="card">
    <div class="check-circle">
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M6 6l12 12M18 6L6 18" stroke="#ffffff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    </div>
    ...
    <div class="recomendacion">
        <%
            out.print(session.getAttribute("recomendacion"));
        %>
    </div>

    <button class="btn-volver" onclick="window.location.href='index.jsp'">Volver al menú</button>
</div>
