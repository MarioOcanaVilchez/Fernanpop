...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="CSS/EditarMensaje.css?v=2">
</head>
<body>
    <%
...
<%
    ...
    session.setAttribute("idMensaje",Long.parseLong(request.getParameter("id")));
    Mensaje mensaje = gestionAPP.buscaMensaje(idChat,Long.parseLong(request.getParameter("id")));
    if (mensaje != null){
        out.print("<form action=\"EnviaMensajeEditado.jsp\" method=\"get\">\n" +
                "    <h1>Mensaje anterior</h1>\n" +
                "    <div class=\"mensaje-wrapper\" data-tipo=\"propio\">\n" +
                "        <div class=\"mensajePropio\">\n" +
                "            <p>" + mensaje.getContenido() + "</p>\n" +
                "            <p>" + Utilidades.pasarFechaHoraBBDD(mensaje.getFecha()) + "</p>\n" +
                "        </div>\n" +
                "    </div>\n" +
