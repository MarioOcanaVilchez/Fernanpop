...
<main class="perfil-contenedor">
    ...
    <section class="tarjeta perfil-cabecera">
        ...
        <div class="perfil-cabecera-datos">
            <h2 class="perfil-nombre"><%= gestionAPP.getUsuario().getNombre() %> <%= gestionAPP.getUsuario().getApel() %></h2>
            <p class="perfil-email"><%= gestionAPP.getUsuario().getEmail() %></p>
            <p class="perfil-bienvenida">Bienvenido de nuevo a FernanPop</p>
        </div>
    </section>
    ...
    <section class="stats-fila">
        ...
        <button type="button" class="tarjeta stat-tarjeta stat-tarjeta-boton" onclick="window.location.href='MisProductos.jsp'">
            <span class="stat-numero"><%= gestionAPP.getProductosUser().size() %></span>
            <span class="stat-etiqueta">Productos</span>
        </button>
        <button type="button" class="tarjeta stat-tarjeta stat-tarjeta-boton" onclick="window.location.href='Compras.jsp'">
            <span class="stat-numero"><%= gestionAPP.getHistoricoCompras().size() %></span>
            <span class="stat-etiqueta">Compras</span>
        </button>
        <button type="button" class="tarjeta stat-tarjeta stat-tarjeta-boton" onclick="window.location.href='Ventas.jsp'">
            <span class="stat-numero">
                <% double media = gestionAPP.getUsuario().notaMedia(gestionAPP.getHistoricoVentas());
                if ( media == -1) out.print("N/A");
            else out.print(media);  %>⭐</span>
            <span class="stat-etiqueta">Valoración</span>
        </button>
    </section>
    ...
    <section class="tarjeta info-personal">
        ...
        <div class="campo-info">
            ...
            <input
                    ...
                    id="nombre"
                    class="input-moderno"
                    value="<%= gestionAPP.getUsuario().getNombre() %>"
                    data-original="<%= gestionAPP.getUsuario().getNombre() %>"
                    oninput="comprobarCambio(this)">
            <button type="button" class="btn-guardar" id="btn-guardar-campo-nombre" onclick="guardarCampo('nombre')">
        ...
        <div class="campo-info">
            ...
            <input
                    ...
                    id="apel"
                    class="input-moderno"
                    value="<%= gestionAPP.getUsuario().getApel() %>"
                    data-original="<%= gestionAPP.getUsuario().getApel() %>"
                    oninput="comprobarCambio(this)">
            <button type="button" class="btn-guardar" id="btn-guardar-campo-apellidos" onclick="guardarCampo('apel')">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M5 4.5h11l3 3v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-14a1 1 0 0 1 1-1z"/>
                    <path d="M8 4.5v5h7v-5"/>
                    <path d="M8 14h8v6H8z"/>
        ...
        <div class="campo-info">
            ...
            <input
                    ...
                    id="email"
                    class="input-moderno"
                    value="<%= gestionAPP.getUsuario().getEmail() %>"
                    data-original="<%= gestionAPP.getUsuario().getEmail() %>"
                    oninput="comprobarCambio(this)">
            <button type="button" class="btn-guardar" id="btn-guardar-campo-email" onclick="guardarCampo('email')">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M5 4.5h11l3 3v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-14a1 1 0 0 1 1-1z"/>
                    <path d="M8 4.5v5h7v-5"/>
                    <path d="M8 14h8v6H8z"/>
        ...
        <div class="campo-info">
            ...
            <input
                    ...
                    id="movil"
                    class="input-moderno"
                    <% if (gestionAPP.getUsuario().getMovil() != 0) out.print("value=\"" + gestionAPP.getUsuario().getMovil() + "\" "); %>
                    data-original="<%= gestionAPP.getUsuario().getMovil() %>"
                    placeholder="Introduce tu teléfono"
                    min="100000000" max="999999999"
                    oninput="comprobarCambio(this)">
            <button type="button" class="btn-guardar" id="btn-guardar-campo-telefono" onclick="guardarCampo('movil')">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M5 4.5h11l3 3v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-14a1 1 0 0 1 1-1z"/>
                    <path d="M8 4.5v5h7v-5"/>
                    <path d="M8 14h8v6H8z"/>
...
<script>
    ...
    function comprobarCambio(input) {
        const contenedorCampo = input.closest('.campo-info');
        const boton = contenedorCampo.querySelector('.btn-guardar');
