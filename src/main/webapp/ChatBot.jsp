...
<head>
    <title>Chatbot</title>
    <link rel="stylesheet" type="text/css" href="CSS/ChatBot.css?v=5">
...
<div id="chat">
    ...
    <div id="enviarMensajes">
        <form action="EnviarPeticionIA.jsp" method="get">
            <input type="text" name="peticion" value="<%=(session.getAttribute("mensajeEscrito") != null? (String) session.getAttribute("mensajeEscrito") : "")%>" required>
            <button>
...
<%
    session.setAttribute("mensajeEscrito",null);
%>
