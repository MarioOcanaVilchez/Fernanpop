...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="CSS/CrearProducto.css?v=2">
...
<% GestionAPP gestionAPP = (GestionAPP) session.getAttribute("controller");
    ...
    session.setAttribute("accion","crearProducto");
%>
...
<form method="post" action="${pageContext.request.contextPath}/SubirImagen" enctype="multipart/form-data">
    ...
    <input type="text" name="descripcion" placeholder="Añade una pequeña descripción" required minlength="20">
    <input type="number" name="precio" step="0.01" required placeholder="Precio" min="0">
    <select name="estado">
        <option value="No determinado" selected>No determinado</option>
