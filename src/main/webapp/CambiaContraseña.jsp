...
<%
    ...
    out.print("</div>");
%>
<form method="get" action="ActualizaContrasenia.jsp">
    <input type="password" name="clave" id="clave" placeholder="Contraseña" required oninput="comprobarCoincidencia()">
    <input type="password" name="comprobacion" id="comprobacion" placeholder="Vuelve a escribir la contraseña" required oninput="comprobarCoincidencia()">
    <button type="submit" id="btnActualizar" disabled>Actualizar</button>
</form>
...
<script>
    function comprobarCoincidencia() {
        ...
        const ambosRellenos = clave.value.length > 0 && comprobacion.value.length > 0;
        const coinciden = clave.value === comprobacion.value;

        boton.disabled = !(ambosRellenos && coinciden);
    }
</script>
